...
name = 'trytonar_payment_collect_cabal'

download_url = 'https://github.com/gcoop-libre/trytond-payment_collect_cabal/tree/%s.%s' % (
...
setup(name=name,
    ...
    author='gcoop-libre',
    url='https://github.com/gcoop-libre/trytond-payment_collect_cabal',
    download_url=download_url,
    package_dir={'trytond.modules.payment_collect_cabal': '.'},
    packages=[
        'trytond.modules.payment_collect_cabal',
        'trytond.modules.payment_collect_cabal.tests',
        ],
    package_data={
        'trytond.modules.payment_collect_cabal': (info.get('xml', [])
    ...
    entry_points="""
    [trytond.modules]
    payment_collect_cabal = trytond.modules.payment_collect_cabal
    """,
    test_suite='tests',
